...
# Active signal patterns (compiled from previous substring list)
_ACTIVE_PATTERNS = [
    ...
    re.compile(r"new\s+dash\s+available", re.IGNORECASE),
    re.compile(r"time\s+to\s+dash", re.IGNORECASE),
    re.compile(r"your\s+earnings", re.IGNORECASE),
